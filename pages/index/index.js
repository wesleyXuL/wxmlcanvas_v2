...
Page({
	...
	drawImage2() {
		this.drawImage2 = new WxmlCanvas({
			width: 340,
			height: 210,
			element: 'canvas2',
			background: '#f0f0f0',
	...
	drawImage3() {
		this.drawImage3 = new WxmlCanvas({
			width: 340,
			height: 210,
			element: 'canvas3',
			background: '#f0f0f0',
	...
	drawImage4() {
		this.drawImage4 = new WxmlCanvas({
			width: 340,
			height: 210,
			element: 'canvas4',
			background: '#f0f0f0',
	...
	drawImage5() {
		this.drawImage5 = new WxmlCanvas({
			width: 340,
			height: 210,
			element: 'canvas5',
			background: '#f0f0f0',
	...
	drawImage6() {
		this.drawImage6 = new WxmlCanvas({
			width: 340,
			height: 210,
			element: 'canvas6',
			background: '#f0f0f0',
	...
	drawImage7() {
		this.drawImage7 = new WxmlCanvas({
			width: 340,
			height: 210,
			element: 'canvas7',
			background: '#f0f0f0',
	...
	drawImage8() {
		this.drawImage8 = new WxmlCanvas({
			width: 340,
			height: 400,
			element: 'canvas8',
			background: '#f0f0f0',
		...
		let height1 =
			20 +
			Math.ceil(
				this.drawImage8.measureWidth(text[0], '16px pingfang') /
					style.text.width
			) *
		...
		let height2 =
			...
			10 +
			Math.ceil(
				this.drawImage8.measureWidth(text[1], '16px pingfang') /
					style.text.width
			) *
				style.text.lineHeight;
		let data8 = {
